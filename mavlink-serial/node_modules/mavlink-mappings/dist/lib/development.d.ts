...
import { MavFrame, MavMissionType, MavParamType, ParamAck, MavProtocolCapability } from './common';
 ...
 */
export declare class FigureEightExecutionStatus extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
