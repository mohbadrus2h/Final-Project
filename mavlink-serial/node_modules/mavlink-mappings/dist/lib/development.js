...
exports.REGISTRY = exports.CurrentMode = exports.AvailableModes = exports.GroupEnd = exports.GroupStart = exports.ComponentInformationBasic = exports.FigureEightExecutionStatus = exports.WifiNetworkInfo = exports.Airspeed = exports.MissionChecksum = exports.ParamAckTransaction = exports.MavCmd = exports.MavStandardMode = exports.ParamTransactionAction = exports.ParamTransactionTransport = exports.AirspeedSensorType = exports.WifiNetworkSecurity = void 0;
 ...
 * MAV_CMD_DO_FIGURE_EIGHT). This may typically send at low rates: of the order of 2Hz.
 */
class FigureEightExecutionStatus extends mavlink_1.MavLinkData {
}
exports.FigureEightExecutionStatus = FigureEightExecutionStatus;
FigureEightExecutionStatus.MSG_ID = 361;
FigureEightExecutionStatus.MSG_NAME = 'FIGURE_EIGHT_EXECUTION_STATUS';
FigureEightExecutionStatus.PAYLOAD_LENGTH = 33;
FigureEightExecutionStatus.MAGIC_NUMBER = 93;
FigureEightExecutionStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('time_usec', 'timeUsec', 0, false, 8, 'uint64_t', 'us'),
    new mavlink_1.MavLinkPacketField('major_radius', 'majorRadius', 8, false, 4, 'float', 'm'),
    new mavlink_1.MavLinkPacketField('minor_radius', 'minorRadius', 12, false, 4, 'float', 'm'),
    new mavlink_1.MavLinkPacketField('orientation', 'orientation', 16, false, 4, 'float', 'rad'),
    new mavlink_1.MavLinkPacketField('x', 'x', 20, false, 4, 'int32_t', ''),
    new mavlink_1.MavLinkPacketField('y', 'y', 24, false, 4, 'int32_t', ''),
    new mavlink_1.MavLinkPacketField('z', 'z', 28, false, 4, 'float', 'm'),
